...
func SetupRouter(db *gorm.DB) *gin.Engine {
	...
	passwordService := service.NewPasswordService(userRepository)
	...
	r.POST(constants.ChangePasswordRoute, handlers.ValidateToken(), handlers.ChangePasswordHandler(passwordService))
